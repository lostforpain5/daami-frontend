  ...
  return (
    <section className="py-16 md:py-24 bg-daami-cream">
      <div className="page-container">
        ...
        <DockGroup className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-5">
          {categories.map((cat, i) => (
            ...
            >
              <Link href={`/category/${cat.slug}`} className="group relative overflow-hidden block">
